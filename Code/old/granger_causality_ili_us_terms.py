...
if valid_terms:
    ...
    plt.title('Granger Causality Test p-values of ILI Data in the US', fontsize=14, pad=20)
    ...
    plt.tight_layout()
    plt.savefig("ShiHaoYang/Results/granger_pvalues_ili_us_terms_plot.png", dpi=300, bbox_inches='tight')
    plt.show()
else:
