...
def save_detailed_significant_terms(model_unrestricted, filtered_columns, max_lag, response_var, test_type="ILI"):
    ...
    for max_lag in range(1, 6):
        ...
        if has_autocorrelation:
            ...
            if ols_u_hac is not None:
                ...
                save_detailed_significant_terms(ols_u_hac, filtered_columns, max_lag, response_var, "ILI")
            else:
                ...
                save_detailed_significant_terms(model_unrestricted, filtered_columns, max_lag, response_var, "ILI")
        else:
