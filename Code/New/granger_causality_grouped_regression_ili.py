...
def main():
    ...
    summary_lines = []
    summary_lines.append(f"Granger Causality Robust Analysis (ILI) - max_lag={max_lag}\n")
    ...
    with open(f'ShiHaoYang/Results/New/granger_causality_robust_summary_ili_max_lag{max_lag}.txt', 'w') as f:
        f.write('\n'.join(summary_lines))
    ...
    print(f"- ShiHaoYang/Results/New/granger_causality_robust_summary_ili_max_lag{max_lag}.txt")
